...
static void InitCurrentFlashLevelScanlineEffect(void)
{
    ...
    else if ((flashLevel = GetFlashLevel()))
    {
        ...
        SetGpuReg(REG_OFFSET_WINOUT, ((WINOUT_WIN01_BG0 | WINOUT_WIN01_BG2 | WINOUT_WIN01_BG3) | WINOUT_WIN01_OBJ | WINOUT_WIN01_CLR)); // where the main tiles are so the window hides whats behind it
