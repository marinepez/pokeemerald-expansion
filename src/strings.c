...
const u8 gText_WeatherBallDance[] = _("Improvise");
const u8 gText_SunnyDayDance[] = _("Radiant");
const u8 gText_RainDanceDance[] = _("Stormy");
const u8 gText_FakeOutDance[] = _("Breakdance");
const u8 gText_GrassyGlideDance[] = _("Smooth");
const u8 gText_TeeterDanceDance[] = _("Silly");
const u8 gText_SwordsDanceDance[] = _("Frenzied");
const u8 gText_AfterYouDance[] = _("Ballroom");
const u8 gText_PetalDanceDance[] = _("Flowery");
const u8 gText_MimicDance[] = _("Simple");
const u8 gText_CaptivateDance[] = _("Tango");
