const u8 gEasyChatWord_Dark[]       = _("We are impressed by your dedication to");
const u8 gEasyChatWord_Stench[]     = _("Pokémon battles. Regretfully, we cannot");
const u8 gEasyChatWord_ThickFat[]   = _("offer you a Gym Leader position at this");
const u8 gEasyChatWord_RainDish[]   = _("time. Your potential remains vast.");
const u8 gEasyChatWord_Drizzle[]    = _("Continue your journey, and we wish");
const u8 gEasyChatWord_ArenaTrap[]  = _("you success in future endeavors.");
const u8 gEasyChatWord_Intimidate[] = _("I hope you made it ok. Your Pokémon are");
const u8 gEasyChatWord_RockHead[]   = _("doing well, but they miss you. I still");
const u8 gEasyChatWord_Color[]      = _("think you're chasing a myth, but I");
const u8 gEasyChatWord_AltColor[]   = _("can't stop you. Be careful out there,");
const u8 gEasyChatWord_Rock[]       = _("I won't forgive you if you don't");
const u8 gEasyChatWord_Beautiful[]  = _("make it back home.");
const u8 gEasyChatWord_Beauty[]     = _("The rumors are true.");
const u8 gEasyChatWord_AirLock[]    = _("MEW inhabits the island.");
const u8 gEasyChatWord_Psychic[]    = _("-, likes    candy?");
const u8 gEasyChatWord_HyperCutter[]= _("     likes");
const u8 gEasyChatWord_Fighting[]   = _("               candy?");
