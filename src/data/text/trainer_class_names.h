const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TEAM_AQUA] = _("PIKACHU"),
    [TRAINER_CLASS_PKMN_BREEDER] = _("{PKMN} BREEDER"),
    [TRAINER_CLASS_COOLTRAINER] = _("PIKACHU"),
    [TRAINER_CLASS_BIRD_KEEPER] = _("BIRD KEEPER"),
    [TRAINER_CLASS_COLLECTOR] = _("WASHED"),
    [TRAINER_CLASS_SWIMMER_M] = _("SWIMMER♂"),
    [TRAINER_CLASS_TEAM_MAGMA] = _("WASHED"),
    [TRAINER_CLASS_EXPERT] = _("WRESTLER"),
    ...
    [TRAINER_CLASS_INTERVIEWER] = _("LEAD"),
    ...
    [TRAINER_CLASS_BATTLE_GIRL] = _("WASHED"),
