...
#define VAR_ALWAYSZERO                                   0x4061 // Unused Var
...
#define VAR_COLOR_R                                      0x407F // (AVIRCODE) (Not implemented yet, will probably be replaced with another system.) These three variables are used to describe the current RGB tone of the palette
#define VAR_COLOR_G                                      0x4080 
#define VAR_COLOR_B                                      0x4081
...
#define VAR_ROLLING_GIANT_AI_STATE                       0x408B // 0: Agressive; 1: Stalking; 2: Dormant
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_ROLLING_GIANT_NUM_SIGHTINGS                  0x4091
...
#define VAR_ROLLING_GIANT_LOCALID                        0x409B
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_LEVEL_LOSS_SPEED                             0x409D // 0: No loss, 1: Slow, 2: Fast (Unused)
#define VAR_MOSSDEEP_SPACE_CENTER_STAIR_GUARD_STATE      0x409E
#define VAR_MOSSDEEP_SPACE_CENTER_STATE                  0x409F
#define VAR_SLATEPORT_HARBOR_STATE                       0x40A0
#define VAR_FLASH_LAYER                                  0x40A1 // Denotes which background layer is removed by flashlight
...
#define VAR_AMC_LIGHT_LEVEL                              0x40A8 // 0: Lights on; 16: Lights completely off
