...
bool8 MetatileBehavior_IsEastBlocked(struct ObjectEvent *);
bool8 MetatileBehavior_IsWestBlocked(struct ObjectEvent *);
bool8 MetatileBehavior_IsNorthBlocked(struct ObjectEvent *);
bool8 MetatileBehavior_IsSouthBlocked(struct ObjectEvent *);
bool8 MetatileBehavior_IsSouthwestBlocked(struct ObjectEvent *);
...
bool8 MetatileBehavior_IsStairsRight(u8);
bool8 MetatileBehavior_IsStairsLeft(u8);
