...
void MoveObjectEventCoordsForGiant(u8 direction, s16 *x, s16 *y);
...
void MovementType_Chase(struct Sprite *);
...
u8 MovementType_Chase_Step0(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step1(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step2(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step3(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step4(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step5(struct ObjectEvent *, struct Sprite *);
u8 MovementType_Chase_Step6(struct ObjectEvent *, struct Sprite *);
...
void ObjectEventUpdateMetatileBehaviors(struct ObjectEvent *objEvent);  // (AVIRCODE) Added so that it can be accessed in field_player_avatar.c
